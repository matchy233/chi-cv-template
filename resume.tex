...
\cventry{Personal Projects}{\textbf{4k} followers skyzh}
\begin{itemize}
  \item \textbf{type-exercise-in-rust}(star 870): Learn Rust black magics (GAT, HRTB, bypassing compiler bugs, macros) by implementing an expression framework in database systems. % TODO: github link
\end{itemize}
