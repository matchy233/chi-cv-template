...
\cventry{RisingLight Community}
  ...
  \cventry{TiKV Community}
    ...
    \begin{itemize}
      ...
      \item Mentored community members to contribute new feature to TiKV in the \textbf{LFX Mentorship}. \iconlink{https://github.com/tikv/tikv/issues/9066}\ \iconlink{https://github.com/tikv/tikv/issues/9747}
    \end{itemize}

\cventry{Personal Projects}{\textbf{4k} followers \iconlink[\faGithub][skyzh]{https://github.com/skyzh}}
\begin{itemize}
  \item \textbf{type-exercise-in-rust} (\faIcon[regular]{star}\ 870): Learn Rust black magics (GAT, HRTB, bypassing compiler bugs, macros) by implementing an expression framework in database systems.\iconlink[\faGithub]{https://github.com/skyzh/type-exercise-in-rust}
\end{itemize}
